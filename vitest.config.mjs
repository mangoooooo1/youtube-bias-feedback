  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        "server/scripts/compute-referrer-composition-trend.js",
        "server/scripts/compute-feedback-engagement-correlation.js",
        "server/scripts/select-interview-candidates.js",
